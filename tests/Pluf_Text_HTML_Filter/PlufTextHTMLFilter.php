...
class PlufTextHTMLFilter extends TestCase
{
    ...
    public function testRunBatchOfTests ()
    {
        ...
        $this->filter_harness('<script woo="yay<b>hello', 
                '&lt;script woo=&quot;yay<b>hello</b>');
        ...
        // bad protocols
        $this->filter_harness('<a href="http://foo">bar</a>', 
                '<a href="http://foo">bar</a>');
        $this->filter_harness('<a href="ftp://foo">bar</a>', 
                '<a href="ftp://foo">bar</a>');
        $this->filter_harness('<a href="mailto:foo">bar</a>', 
                '<a href="mailto:foo">bar</a>');
        $this->filter_harness('<a href="javascript:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java' . "\t" . 'script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java' . "\n" . 'script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java' . "\r" . 'script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java' . chr(1) . 'script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="java' . chr(0) . 'script:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="jscript:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="vbscript:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="view-source:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="  javascript:foo">bar</a>', 
                '<a href="#foo">bar</a>');
        $this->filter_harness('<a href="jAvAsCrIpT:foo">bar</a>', 
        ...
        $this->filter_harness('hello <!-- foo --> world', 
                'hello <!-- foo --> world');
        $this->filter_harness('hello <!-- <foo --> world', 
                'hello <!-- &lt;foo --> world');
        $this->filter_harness('hello <!-- foo> --> world', 
        ...
        $this->filter_harness('<a href="foo"bar">baz</a>', 
                '<a href="foo">baz</a>');
        $this->filter_harness('<a href=foo"bar>baz</a>', 
                '<a href="foo">baz</a>');
        ...
        // entity decoder - '<'
        $entities = explode(' ', 
                "%3c %3C &#60 &#0000060 &#60; &#0000060; &#x3c &#x000003c &#x3c; &#x000003c; &#X3c &#X000003c &#X3c; &#X000003c; &#x3C &#x000003C &#x3C; &#x000003C; &#X3C &#X000003C &#X3C; &#X000003C;");
        ...
        $this->filter_harness("<img src='foo.jpg' />", '<img src="foo.jpg" />');
        $this->filter_harness("<img src=\"foo.jpg\" />", 
                '<img src="foo.jpg" />');
        ...
        $this->filter_harness('<a href="woo.htm%22%20bar=%22#">foo</a>', 
                '<a href="woo.htm&quot; bar=&quot;#">foo</a>');
        $this->filter_harness(
                '<a href="woo.htm%22%3E%3C/a%3E%3Cscript%3E%3C/script%3E%3Ca%20href=%22#">foo</a>', 
                '<a href="woo.htm&quot;&gt;&lt;/a&gt;&lt;script&gt;&lt;/script&gt;&lt;a href=&quot;#">foo</a>');
        $this->filter_harness('<a href="woo.htm%aa">foo</a>', 
                '<a href="woo.htm%aa">foo</a>');
    }
