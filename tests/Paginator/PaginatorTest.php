 ...
 */
class Paginator_PaginatorTest extends TestCase
{
    ...
    {
        $pag = new Paginator(new PaginatorMyModel());
    ...
    {
        $item1 = new PaginatorMyModel();
        $item1->title = 'a';
        $item1->description = 'description';
        $item1->create();

        $item2 = new PaginatorMyModel();
        $item2->title = 'b';
     ...
     *
     * @test
     * @expectedException \Pluf\BadRequestException
     */
