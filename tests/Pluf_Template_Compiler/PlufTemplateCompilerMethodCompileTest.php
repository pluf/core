...
class PlufTemplateCompilerMethodCompileTest extends TestCase
{
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-test1.html', array(
            dirname(__FILE__)
        ));
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-test2.html', array(
            dirname(__FILE__)
        ));
        $this->assertEquals('<?php Pluf_Template_safeEcho($t->_vars->toto); ?>' . "\n\n", $compiler->getCompiledTemplate());
    }
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-test3.html', array(
            dirname(__FILE__)
        ));
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-test5.html', array(
            dirname(__FILE__)
        ));
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-teststring.html', array(
            dirname(__FILE__)
        ));
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-teststring-modifier.html', array(
            dirname(__FILE__)
        ));
    ...
    public function testCompileSimpleBlockTrans()
    {
        ...
        $this->assertEquals('<?php ob_start(); ?>Youpla boum %1$s is here.<?php $_b_t_s=ob_get_contents(); ob_end_clean(); echo(sprintf(__($_b_t_s), Pluf_Template_safeEcho($t->_vars->toto, false))); ?>', $compiler->getCompiledTemplate());
    }
