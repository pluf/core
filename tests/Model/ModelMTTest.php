...
class ModelMTTest extends TestCase
{
    ...
    public function testLimitRelatedTestModel()
    {
        ...
        $this->assertEquals(true, $m->create());
        $rel = $model->get_relatedtotestmodel_list(array(
    ...
    public function testManyRelatedTestModel()
    {
        ...
        $rm1 = new Test\RelatedToTestModel2();
        $rm1->testmodel_1 = $tm1;
        $rm1->testmodel_2 = $tm2;
        $rm1->dummy = 'stupid values rm1';
        $rm1->create();

        $rm2 = new Test\RelatedToTestModel2();
        $rm2->testmodel_1 = $tm1;
        $rm2->testmodel_2 = $tm2;
        $rm2->dummy = 'stupid values rm2';
        $rm2->create();

        $rm3 = new Test\RelatedToTestModel2();
        $rm3->testmodel_1 = $tm1;
        $rm3->testmodel_2 = $tm3;
