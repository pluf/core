...
// */
//public class DeserializerJson implements JsonDeserializer<RPaginatorPage> {
//
//    @Override
//    public RPaginatorPage deserialize(JsonElement je, Type type, JsonDeserializationContext jdc)
//            throws JsonParseException {
//        Gson gson = new Gson();
//        Type paginatorPageType = new TypeToken<RPaginatorPage>() {}.getType();
//        RPaginatorPage pagedResponse = gson.fromJson(je, paginatorPageType);
//
//        
//        Type ct ;
