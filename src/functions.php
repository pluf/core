 ...
 */
function getRequestParamOr403 ($request, $id)
{
...
function getRequestParam ($request, $id)
{
    if (array_key_exists($id, $request->REQUEST)) {
        return $request->REQUEST[$id];
    }
 ...
 */
function getObjectOr404 ($object, $id)
{
    $item = new $object($id);
 ...
 */
function renderToResponse ($tplfile, $params, $request = null)
{
 ...
 */
function getFormForModel ($model, $data = null, $extra = array(),
        $label_suffix = null)
{
    $extra['model'] = $model;
 ...
 */
function getFormForUpdateModel ($model, $data = null,
 ...
 *
 * @param string $modelName1 name of model (of type Model)
 * @param string $modelName2 name of model (of type Model)
 * @return string name of association table for given modeles.
 *
 * @deprecated use ModelUtil::getAssocTable($from,$to);
 */
function getAssociationTableName($modelName1, $modelName2){
    $hay = array(
 ...
 *
 * @param string $modelName name of model (of type Model)
 * @return string column name for given model as foreign key in an association table.
 */
function getForeignKeyName($modelName){
