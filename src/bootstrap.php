...
class Pluf
{
    ...
    public static function start($config)
    {
        ...
        } else if (false !== ($file = self::fileExists($config))) {
        ...
        date_default_timezone_set(self::getConfig('time_zone', 'UTC'));
        mb_internal_encoding(self::getConfig('encoding', 'UTF-8'));
        mb_regex_encoding(self::getConfig('encoding', 'UTF-8'));
