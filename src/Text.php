    ...
    public static function preventUpperCase($string, $mode = MB_CASE_TITLE)
    {
        ...
        if ($n_elts > 1) {
            ...
            if ((float) $tot / (float) $n_elts >= 0.5) {
                return mb_convert_case(mb_strtolower($string, 'UTF-8'), $mode, 'UTF-8');
            }
        }
        return $string;
    }
