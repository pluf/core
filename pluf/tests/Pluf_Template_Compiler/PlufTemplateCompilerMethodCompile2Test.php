...
class PlufTemplateCompilerMethodCompile2Test extends PHPUnit_Framework_TestCase {
    ...
    {
        $compiler = new Pluf_Template_Compiler('tpl-extends.html', array(dirname(__FILE__)));
