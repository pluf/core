...
function SaaS_Migrations_Install_setup ($params = null)
{
    ...
    $perm = new Pluf_Permission();
    $perm->name = 'SPA anonymous users';
    $perm->code_name = 'spa-anonymous-access';
    $perm->description = 'Permission given to application';
    $perm->application = 'SaaS';
    $perm->create();
    
    $perm = new Pluf_Permission();
    $perm->name = 'SPA authorized users';
    $perm->code_name = 'spa-authorized-access';
    $perm->description = 'Permission given to application';
    $perm->application = 'SaaS';
    $perm->create();
    
    $perm = new Pluf_Permission();
    $perm->name = 'SPA member users';
    $perm->code_name = 'spa-member-access';
    $perm->description = 'Permission given to application';
    $perm->application = 'SaaS';
    $perm->create();
    
    $perm = new Pluf_Permission();
    $perm->name = 'SPA owner users';
    $perm->code_name = 'spa-owner-access';
    $perm->description = 'Permission given to application';
    $perm->application = 'SaaS';
    $perm->create();
}
