 ...
 */
app.factory('AdminUserManager', function($rootScope, $http, $q, $window, User, PaginatorPage) {
	var manager = {
		_pool : {},
		_get : function(id) {
		 ...
		 * جستجو کاربران
		 * 
		 * از بین تمام کاربران موجود کاربر مورد نظر را جستجو می‌کند. این جستحو
		 * بر اساس راهکارهای صفحه بندی ارائه شده در Pluf طراحی شده است.
		 */
