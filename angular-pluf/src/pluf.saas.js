(function() {
  ...
  saasMadule.factory('SaaSManager', function($rootScope, $http, $q, $window,
    ...
    var manager = {
      ...
      /**
       * امکان جستجو را فراهم می‌کند. این روش جستجو قدیمی است و ممکن است که در
       * نسخه‌های بعد حذف شود. به جای استفاده از این روش از pagenate استفاده
       * کنید.
       */
      ...
      /**
       * با استفاده از این فراخوانی یکی از خصوصیت‌های یک نرم‌افزار کاربردی به
       * روز می‌شود.
       */
